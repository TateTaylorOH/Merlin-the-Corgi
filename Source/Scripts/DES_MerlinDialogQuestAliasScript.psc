Scriptname DES_MerlinDialogQuestAliasScript extends ReferenceAlias  
...
Event OnUpdateGameTime()
     ...
     If Self.GetActorRef().GetActorValue("WaitingforPlayer") == 1
          ...
          (GetOwningQuest() as DES_MerlinFollowerFramework).DismissFollower(0,0)
     EndIf
EndEvent
...
Event OnUnload()
     ...
     If Self.GetActorReference().GetActorValue("WaitingforPlayer") == 1
          (GetOwningQuest() as DES_MerlinFollowerFramework).FollowerWait()
     EndIf
EndEvent
